...
from this directory. Then, you may use `from animate_structure import animate`. To learn how to use `animate()`, look at its docstring and `tests.py` (for which the outputs are in data/).
